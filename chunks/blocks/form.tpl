{set $isDescExist = !$isDescHidden}
{set $togglerId = $target ? $target ~ '_confirm' : 'confirm'}
{set $fields}
            ...
            <div class="modal-content">
                <div class="modal-container form-container js-form">
                    <div class="form-header js-form-header">
                        <div class="form-title js-form-title">{$title ?: 'Оставьте свой номер'}</div>
                        {if $isDescExist}<div class="form-desc">{$desc ?: 'и мы свяжемся с вами в ближайшее время'}</div>{/if}
                    </div>
                    ...
                    <form class="form js-form-content" data-ym="" data-action="{$action ?: '/feedback'}">
                        ...
                        <fieldset class="form__fieldset">{$fieldset ?: $fields}</fieldset>
                        <div class="form-toggler-row js-input-holder">
                            <input
                              ...
                              checked
                            />
                            <label class="form-toggler-label form__label" for="{$togglerId}">
